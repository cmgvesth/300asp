...
pdf('afolder/a3_orgs2cluster-all-cutoff-clustered-bestcand-tree.pdf')
...
pdf('afolder/a3_orgs2cluster-all-cutoff-clustered-bestcand-notree.pdf')
colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
heatmap.2(mat, main="All nigri clusters, mostly white, clustered", dendrogram="both", trace = "none", ColSideColor=ccol_stages, Rowv=TRUE, Colv=TRUE ,col=colfunc, breaks=b, labCol=FALSE, density.info="none", margins =c(4,10))
...
pdf('afolder/a3_orgs2cluster-all-color-clustered-bestcand.pdf')
...
pdf('afolder/a3_orgs2cluster-all-cutoff-unclustered-bestcand.pdf')
colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-all-cutoff-orgclustered-bestcand-blackwhite.pdf', width=12, height=8)
colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-all-cutoff-bothclustered-bestcand-blackwhite.pdf', width=12, height=8)
colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-10-cutoff-clustered-bestcand.pdf')
colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-10-range-clustered-bestcand.pdf')
colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-10-cutoff-unclustered-bestcand.pdf')
colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-10-cutoff-orgclustered-bestcand.pdf')
colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
...
# pdf('afolder/a3_orgs2cluster-Aspni7-cutoff-clustered.pdf')
# colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
...
# pdf('afolder/a3_orgs2cluster-Aspni7-range-clustered.pdf')
# colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
...
# pdf('afolder/a3_orgs2cluster-Aspni7-cutoff-unclustered.pdf')
# colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
...
# pdf('afolder/a3_orgs2cluster-Aspni7-cutoff-orgclustered.pdf')
# colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
...
# pdf('afolder/a3_orgs2cluster-10-cutoff-clustered.pdf')
# colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
# heatmap.2(mat, main="Size >10 nigri clusters, mostly white, clustered", dendrogram="both", trace = "none", ColSideColor=ccol_stages, Rowv=TRUE, Colv=TRUE ,col=colfunc, breaks=b, labCol=FALSE, density.info="none", margins =c(4,10))
# dev.off()

# pdf('afolder/a3_orgs2cluster-10-range-clustered.pdf')
# colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
# heatmap.2(mat, main="Size >10 nigri clusters, clustered",dendrogram="both", trace = "none", ColSideColor=ccol_stages, Rowv=TRUE, Colv=TRUE , col=colfunc, breaks=b, labCol=FALSE, density.info="none", margins =c(4,10))
# dev.off()

# pdf('afolder/a3_orgs2cluster-10-cutoff-unclustered.pdf')
# colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
# heatmap.2(mat, main="Size >10 nigri clusters, unclustered", dendrogram="none", trace = "none", ColSideColor=ccol_stages, Rowv=FALSE, Colv=FALSE , col=colfunc, breaks=b, labCol=FALSE, density.info="none", margins =c(4,10))
# dev.off()

# pdf('afolder/a3_orgs2cluster-10-cutoff-orgclustered.pdf')
# colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
# heatmap.2(mat, main="Size >10 nigri clusters, organism clustered", dendrogram="row", trace = "none", ColSideColor=ccol_stages, Rowv=TRUE, Colv=FALSE , col=colfunc, breaks=b, labCol=FALSE, density.info="none", margins =c(4,10))
# dev.off()

# pdf('afolder/a3_orgs2cluster-color-pie.pdf')
