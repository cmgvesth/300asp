...
#orgString <- tmpdat$q_orgname=="Aspnov1" | tmpdat$q_orgname=="Aspfu1"

tmpdat <- read.csv(infile, sep=";", header=TRUE)

subdat <- subset(tmpdat, (orgString) & tmpdat$q_orgname!="Aspac1" & tmpdat$h_orgname!="Aspac1", select=c(12,3,6,8)) 
...
pdf('afolder/a3_orgs2cluster-all-cutoff-clustered-bestcand-tree.pdf', width=plotwidth, height=plotheight)
...
pdf('afolder/a3_orgs2cluster-all-cutoff-clustered-bestcand-notree.pdf', width=plotwidth, height=plotheight)
#colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
heatmap.2(mat, main="All clusters, mostly white, clustered", dendrogram="both", trace = "none", ColSideColor=ccol_stages, 
	Rowv=TRUE, Colv=TRUE ,col=colfunc, breaks=b,  density.info="none", margins =c(plotwidth,plotheight))
...
pdf('afolder/a3_orgs2cluster-all-color-clustered-bestcand.pdf', width=plotwidth, height=plotheight)
colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-all-color-clusteredrow-bestcand.pdf', width=plotwidth, height=plotheight)
colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-all-cutoff-unclustered-bestcand.pdf', width=plotwidth, height=plotheight)
#colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-all-cutoff-orgclustered-bestcand-blackwhite.pdf', width=plotwidth, height=plotheight )
#colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-all-cutoff-bothclustered-bestcand-blackwhite.pdf', width=plotwidth, height=plotheight)
#colfunc <- c("white"  ,"white", "white" ,"#2B8CBE","#084081")
colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
...
subdat <- subset(tmpdat, tmpdat$q_clust_size>10 & (orgString) & tmpdat$q_orgname!="Aspac1" & tmpdat$h_orgname!="Aspac1", select=c(12,3,6,8)) # q_orgid,
...
pdf('afolder/a3_orgs2cluster-10-cutoff-clustered-bestcand.pdf', width=plotwidth, height=plotheight)
colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-10-range-clustered-bestcand.pdf', width=plotwidth, height=plotheight)
colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-10-cutoff-unclustered-bestcand.pdf', width=plotwidth, height=plotheight)
colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
...
pdf('afolder/a3_orgs2cluster-10-cutoff-orgclustered-bestcand.pdf', width=plotwidth, height=plotheight)
colfunc <- c("white"  ,"#CCEBC5", "#7BCCC4" ,"#2B8CBE","#084081")
...
for (s in unique(orgdat$q_orgname)) {
	filename = paste("afolder/a3_orgs2cluster-clustered-bestcand_", s, ".pdf", sep="")
