...
parser.add_argument("-qfile", "-qf", required=True, help="File containing mysql query")
...
if columns and result:
	cursor2csv(columns, result, "cursor2csv_main.csv") # costum function
...
if tquery:
	...
	if columns and result:
		cursor2csv(columns, result, "cursor2csv_test.csv") # costum function
